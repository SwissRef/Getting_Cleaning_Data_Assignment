...
replaceterm <- c("Time_", "Frequency_", "Accelerometer_", "Gyroscope_", "Jerk_", "Magnitude_", 
                 "Mean", "Std-Deviation","Mean-Frequency", "_X-Axis","_Y-Axis","_Z-Axis","Body","Body-motion_","Gravity_")
